...
if (typeof supabase === 'undefined') {
    ...
    const ratingData = [
        ...
        { rank: 4, name: 'Бекзат Есетов', points: 860, club: 'SDU' },
        { rank: 5, name: 'Ерасыл Еркебұлан', points: 856, club: 'Дербес' },
        { rank: 6, name: 'Айдана Жұмаева', points: 848, club: 'Алтын Сапа' },
        { rank: 7, name: 'Мейіржан Төлеген', points: 844, club: 'UIB' },
        { rank: 8, name: 'Данияр Құрманғали', points: 840, club: 'Зиялы Қазақ' },
        { rank: 9, name: 'Аружан Сейдахмет', points: 836, club: 'Сириус' },
        { rank: 10, name: 'Қайсар Ержан', points: 832, club: 'НЛО' },
        { rank: 11, name: 'Айгерім Нұрлан', points: 828, club: 'Дербес' },
        { rank: 12, name: 'Ернұр Бақыт', points: 824, club: 'КБТУ' },
        { rank: 13, name: 'Айым Серикова', points: 820, club: 'Алтын Сапа' },
        { rank: 14, name: 'Темірлан Жанат', points: 816, club: 'SDU' },
        { rank: 15, name: 'Динара Ермек', points: 812, club: 'Зиялы Қазақ' },
    ];
